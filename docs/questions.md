...
- Requested composites and side-by-side groups are now represented by separate image references within one gallery slide. This includes chapter 2, chapter 3 layered source images, chapter 4 *Kirchenunion*, chapter 6.1 Hoffmann's *Flora*, and chapter 6.3. The only known missing member is `6.3_04_1d_Schwarzwälder_D5_TSS`, recorded below.
