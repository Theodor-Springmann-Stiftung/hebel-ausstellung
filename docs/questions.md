...
- Confirmed composites and side-by-side groups are represented by separate image references within one gallery slide. This includes chapter 2, chapter 3 layered source images, chapter 6.1 Hoffmann's *Flora*, and chapter 6.3 galleries 3 and 5. Chapter 4 *Kirchenunion* and chapter 6.3 galleries 1, 2, and 4 intentionally retain separate carousel slides. The only known missing member is `6.3_04_1d_Schwarzwälder_D5_TSS`, recorded below.
...
- The chapter hero uses the original wrapper by itself. Its caption, alt text, and object relationship were adjusted accordingly; the former questionnaire request for a wrapper/title-page montage is obsolete.
